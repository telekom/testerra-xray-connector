...
public enum Fields implements Field {
    ...
    TEST_EXECUTION_REVISION(new PropertyField("xray.test.execution.revision.field.id")),
    TEST_EXECUTION_TEST_ENVIRONMENTS(new PropertyField("xray.test.execution.test-environments.field.id")),
    TEST_EXECUTION_TEST_PLANS(new PropertyField("xray.test.execution.test-plans.field.id")),
