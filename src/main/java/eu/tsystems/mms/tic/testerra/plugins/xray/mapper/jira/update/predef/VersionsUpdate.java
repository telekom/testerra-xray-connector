...
public abstract class VersionsUpdate implements FieldUpdate {

    protected final String[] versionNames;

    public VersionsUpdate(final String... versionNames) {
    ...
    public JiraValue getJiraValue() {
        return new JiraNameValueArray(versionNames);
    }
}
