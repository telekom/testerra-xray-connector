...
public class KeyInTestSetTests extends DefaultJqlCondition {

    public KeyInTestSetTests(final String testSetKey) {
        super("key", Operator.In, new SingleValueFunction("testSetTests", testSetKey));
    }
}
