...
public class SummaryContainsExact extends DefaultJqlCondition {

    public SummaryContainsExact(final String summary) {
        super("summary", Operator.Contains, new ExactSingleValue(summary));
    }
}
