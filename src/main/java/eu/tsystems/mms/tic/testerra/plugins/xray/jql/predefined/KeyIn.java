...
public class KeyIn extends DefaultJqlCondition {
    public KeyIn(final List<String> issueKeys) {
        super("key", Operator.In, new MultiValue(issueKeys));
    }

    public KeyIn(final String issueKey) {
        this(Lists.newArrayList(issueKey));
    }
}
