...
public class ProjectEquals extends DefaultJqlCondition {

    public ProjectEquals(final String projectIdentifier) {
        super("project", Operator.Equals, new SingleValue(projectIdentifier));
    }
}
